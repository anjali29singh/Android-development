    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPickTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getApplicationContext(),silentTimeListener,silentHour,silentMinute,false);
            }
        });
        ...
        endPickTime.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getApplicationContext(),unsilentTimeListener,unsilentHour,unsilentMinute,false);
